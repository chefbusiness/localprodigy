...
const faqs = [
  {
    question: "¿Qué resultados puedo esperar del marketing digital para mi despacho?",
  ...
  {
    question: "¿Cómo se diferencia el marketing digital para abogados de otros sectores?",
    answer: "El marketing legal requiere un enfoque especializado que considere las regulaciones profesionales, la sensibilidad de la información y la necesidad de construir confianza. Nos centramos en estrategias que resaltan su experiencia y credenciales mientras mantenemos los más altos estándares éticos."
  },
  {
    question: "¿Cuánto tiempo lleva ver resultados en SEO legal?",
