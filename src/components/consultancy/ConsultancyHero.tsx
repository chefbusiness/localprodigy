    ...
    <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-muted to-background">
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="Despacho de asesoría moderno con profesionales trabajando"
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              asChild 
              size="lg" 
              className="bg-yellow hover:bg-yellow-dark text-yellow-foreground text-lg animate-fade-up w-full sm:w-auto"
            >
            ...
            <Button 
              ...
              size="lg" 
              variant="outline" 
              className="text-lg animate-fade-up hover:bg-white/10 w-full sm:w-auto"
            >
