    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Con una estrategia de marketing digital bien ejecut

Let's refactor the psychology services page to improve SEO practices, add proper metadata, and implement schema markup while maintaining the existing functionality.

<lov-code>
We need to:
1. Create a new schema component for psychology services
2. Update the main page component to include proper metadata and schema
3. Ensure all breadcrumbs have proper schema markup

First, let's create a new schema component:

<lov-write file_path="src/components/psychology/PsychologySchema.tsx">
import { Helmet } from "react-helmet";
