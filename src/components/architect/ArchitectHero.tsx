    ...
    <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-muted to-background">
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="Estudio de arquitectura moderno con planos y maquetas"
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-up">
            Atraiga Más Clientes Para Su Estudio de Arquitectura
          </h1>
          <p className="text-xl text-muted-foreground mb-8 animate-fade-up leading-relaxed">
            Especialistas en marketing digital para estudios de arquitectura. Aumente su visibilidad online y genere más consultas de clientes potenciales en su zona.
          </p>
