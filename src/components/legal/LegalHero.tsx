      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-up">
            Atraiga Más Clientes Cualificados Para Su Despacho
          </h1>
          <p className="text-xl text-muted-foreground mb-8 animate-fade-up leading-relaxed">
            Especialistas en marketing digital para bufetes y despachos de abogados. Aumente su visibilidad online y genere consultas de clientes potenciales.
          </p>
