...
import HospitalityAndRestaurants from "@/pages/sectors/HospitalityAndRestaurants";
      ...
      <TooltipProvider>
        ...
        <Router>
          <Routes>
            ...
            <Route path="/sectores/hosteleria-restauracion" element={<HospitalityAndRestaurants />} />
